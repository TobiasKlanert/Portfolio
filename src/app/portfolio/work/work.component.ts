...
export class WorkComponent {
  ...
  projects = [
    ...
    {
      technologies: ['Angular', 'TypeScript', 'Django', 'DRF', 'Docker'],
      github: 'https://github.com/TobiasKlanert/talkcore',
      liveLink: '',
      icon: '/assets/img/icon_talkcore.svg',
      screenshot: '/assets/img/screenshot_talkcore.png',
      bgColor: '#679AAC',
      spinner: '/assets/img/spinning_shape.svg',
      linksActive: false,
    },
